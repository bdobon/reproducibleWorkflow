...
Check for the libraries and install them.
...
Obtain the dataset and load it.
...
Calculate the year of each participant, plot the mean age by gender. Need to change the year format. 
